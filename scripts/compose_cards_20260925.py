...
# -*- coding: utf-8 -*-
"""
compose_cards_20260925.py
PIL 合成: 5 张商品图 + 详情文字 → 1080px 宽商品详情长图
然后 5 等份裁剪 + 1 张全图, 供 upload_cloudimgs.py 上传
(基于 compose_cards_20260924.py, 主题色调整为 9 月底秋分后森林绿 + 米白 + 暖棕)
"""
import json
...
# 颜色 - 9 月底秋分后森林绿 + 米白 + 暖棕 (换季收纳/食补/换季主题)
COLOR_BG = (250, 247, 240)
COLOR_TEXT = (38, 50, 42)
COLOR_ACCENT = (96, 124, 90)  # 森林绿 (秋分后换季)
COLOR_ACCENT_2 = (170, 120, 70)  # 暖棕强调
COLOR_TAG = (235, 232, 220)
COLOR_TAG_TEXT = (76, 88, 70)
COLOR_PRICE = (192, 64, 38)
COLOR_BORDER = (220, 212, 198)
...
def render_card(idx, p):
    ...
    # 分类标签 (左)
    draw.rounded_rectangle([48, content_y + 36, 48 + 240, content_y + 86], radius=24, fill=COLOR_TAG)
    draw.text((68, content_y + 44), truncate(draw, p['category'], font_bold(26), 220), font=font_bold(26), fill=COLOR_TAG_TEXT)
    ...
    if p.get('price_note'):
        ...
        draw.text((48, content_y + 222), pn, font=font(20), fill=(80, 100, 120))

    # 分隔线
    draw.line([48, content_y + 270, WIDTH - 48, content_y + 270], fill=COLOR_BORDER, width=2)

    # 5 大卖点
    draw.text((48, content_y + 290), "✦ 5 大亮点", font=font_bold(28), fill=COLOR_ACCENT_2)
    ...
    bot_y += 30
    draw.text((48, bot_y), f"🎨 颜色: {p.get('color', '')}", font=font(20), fill=(80, 90, 110))
...
def main():
    ...
    full_draw.text((48, 65), data['title'], font=font(20), fill=(235, 232, 220))
    ...
    for idx in range(1, len(products) + 1):
        ...
        # upload_cloudimgs.py 期望 product_slice_1.jpg 不带前导零
        ...
        # 同步保留 product_slice_01.jpg 命名 (9/24 飞书脚本兼容)
