...
# -*- coding: utf-8 -*-
"""
compose_cards_20260924.py
PIL 合成: 5 张商品图 + 详情文字 → 1080px 宽商品详情长图
然后 5 等份裁剪 + 1 张全图, 供 upload_cloudimgs.py 上传
(基于 compose_cards_20260920.py, 主题色调整为 9 月底秋分后暖棕 + 高级咖)
"""
import json
...
# 颜色 - 9 月底秋分后主题 (暖棕 + 高级咖 + 米白)
COLOR_BG = (252, 248, 242)
COLOR_TEXT = (52, 38, 28)
COLOR_ACCENT = (156, 88, 50)  # 暖棕 (秋分后)
COLOR_ACCENT_2 = (208, 138, 76)  # 浅咖强调
COLOR_TAG = (245, 232, 218)
COLOR_TAG_TEXT = (118, 62, 38)
COLOR_PRICE = (192, 64, 38)
COLOR_BORDER = (228, 218, 200)
...
def main():
    ...
    full_draw.text((48, 65), data['title'], font=font(20), fill=(245, 232, 218))
