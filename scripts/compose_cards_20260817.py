...
# 商品主色调 (背景, 文字, 强调色)
THEMES = [
    ("#E3F2FD", "#1565C0", "#42A5F5"),  # 大疆Pocket4-蓝
    ("#E8F5E9", "#1B5E20", "#43A047"),  # 小米路由器-绿
    ("#EDE7F6", "#6A1B9A", "#AB47BC"),  # 戴森Airwrap-紫
    ("#FFF3E0", "#E65100", "#FB8C00"),  # 九阳破壁机-橙
    ("#FFEBEE", "#B71C1C", "#E53935"),  # 创维电视-红
]
