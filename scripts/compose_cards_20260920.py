...
# 颜色 - 9 月职场通勤主题 (深蓝 + 暖橙强调)
COLOR_BG = (248, 250, 252)
COLOR_TEXT = (38, 50, 68)
COLOR_ACCENT = (43, 76, 140)  # 职场通勤深蓝
COLOR_ACCENT_2 = (228, 132, 56)  # 暖橙强调
COLOR_TAG = (235, 240, 250)
COLOR_TAG_TEXT = (43, 76, 140)
COLOR_PRICE = (208, 56, 38)
COLOR_BORDER = (220, 228, 240)
...
def main():
    ...
    full_draw.text((48, 65), data['title'], font=font(20), fill=(220, 230, 250))
